...
{# mu_gamma
  mu_gammaCols_23_chain1 <- samples4$samples[, c(mu_beta_list[31:60], mu_beta_list[181:210], mu_beta_list[331:360])]
  ...
  mu_gammaCols_23_chain1 <- samples4$samples[, mu_beta_list[1:30]]
  mu_gammaMn_23_chain1 <- colMeans(mu_gammaCols_23_chain1)
