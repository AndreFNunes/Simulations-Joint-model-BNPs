...
samples3 <- runMCMC(CsimMCMC, niter = 13000, nburnin = 5000, thin = 50, summary = TRUE)


par(mfrow=c(4,4))

plot(samples3$samples[ , 'beta0'], type = 'l', xlab = 'iteration',  ylab = expression(beta0))
plot(samples3$samples[ , 'beta[1]'], type = 'l', xlab = 'iteration', ylab = expression(beta1))
plot(samples3$samples[ , 'beta[2]'], type = 'l', xlab = 'iteration', ylab = expression(beta2))
plot(samples3$samples[ , 'beta[3]'], type = 'l', xlab = 'iteration', ylab = expression(beta3))

##########

plot(samples3$samples[ , 'beta02'], type = 'l', xlab = 'iteration',  ylab = expression(beta02))
plot(samples3$samples[ , 'beta2[1]'], type = 'l', xlab = 'iteration', ylab = expression(beta21))
plot(samples3$samples[ , 'beta2[2]'], type = 'l', xlab = 'iteration', ylab = expression(beta22))
plot(samples3$samples[ , 'beta2[3]'], type = 'l', xlab = 'iteration', ylab = expression(beta23))
...
{# mu_gamma
  mu_gammaCols_23_chain1 <- samples3$samples[, mu_gamma_list]
  ...
  plot(samples3$samples[ , 'mu_beta[1]'], type = 'l', xlab = 'iteration', ylab = expression(mu_beta1))
  plot(samples3$samples[ , 'mu_beta[2]'], type = 'l', xlab = 'iteration', ylab = expression(mu_beta2))
  plot(samples3$samples[ , 'mu_beta[3]'], type = 'l', xlab = 'iteration', ylab = expression(mu_beta3))
  
  # mu_gammaCols_23_chain1 <- samples3$samples[, mu_beta_list[31:60]]
  # mu_gammaMn_23_chain1 <- colMeans(mu_gammaCols_23_chain1)
  ...
  # 
  # mu_gammaCols_23_chain1 <- samples3$samples[, mu_beta_list[181:210]]
  # mu_gammaMn_23_chain1 <- colMeans(mu_gammaCols_23_chain1)
  ...
  # 
  # mu_gammaCols_23_chain1 <- samples3$samples[, mu_beta_list[331:360]]
  # mu_gammaMn_23_chain1 <- colMeans(mu_gammaCols_23_chain1)
...
###############################################################################################
{{# gamma
  gammaCols_23_chain1 <- samples3$samples[, gamma_list]
  ...
  {# tau2_gamma
    tau2_gammaCols_23_chain1 <- samples3$samples[, tau2_gamma_list]
  ...
  hist(samples3$samples[, "alpha"])
}

samples3$summary['beta0',]
samples3$summary['beta[1]',]
samples3$summary['beta[2]',]
samples3$summary['beta[3]',]

samples3$summary['beta02',]
samples3$summary['beta2[1]',]
samples3$summary['beta2[2]',]
samples3$summary['beta2[3]',]
...
prob_list_estim <- samples3$samples[, prob_list]
prob_list_estim_mean <- matrix(colMeans(prob_list_estim), nrow = 120, ncol = 21)

prob2_list_estim <- samples3$samples[, prob2_list]
